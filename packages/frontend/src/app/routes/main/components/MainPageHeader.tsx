...
export const MainPageHeader: FC<IMainPageHeaderProps> = (props) => {
  ...
  if (selectedChainId && selectedChainId != props.appProviders.targetNetwork.chainId) {
    const description = (
      <div>
  ...
  return (
    <>
      ...
      {/* {networkDisplay}
      {right} */}
      <Button onClick={() => (connector !== undefined ? ethersContext.openModal(connector) : console.log('Null'))}>
        CONNECT
      </Button>
    </>
  );
